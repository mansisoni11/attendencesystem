...
mansi_image= face_recognition.load_image_file("images/mansi.jpeg")
# mansi_encoding = face_recognition.face_encoding(mansi_image)[0]
mansi_encoding = face_recognition.face_encodings(mansi_image)[0]
kartik_image = face_recognition.load_image_file("images/kartik.jpeg")
kartik_encoding = face_recognition.face_encodings(kartik_image)[0]
known_face_encodings=[mansi_encoding,kartik_encoding]
known_face_names=["mansi","kartik"]
